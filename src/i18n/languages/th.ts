...
export const th: Translation = {
	...
	[Key.musicBoxPrev]: "ก่อนหน้า",
	[Key.musicBoxNext]: "ถัดไป",
	[Key.musicBoxPlaylist]: "รายการเล่น",
	[Key.musicBoxMode]: "โหมดการเล่น",
	[Key.musicBoxVolume]: "ระดับเสียง",
	[Key.musicBoxMute]: "ปิดเสียง",
	[Key.musicBoxUnmute]: "เปิดเสียง",
	[Key.musicBoxShuffle]: "สุ่ม",
	[Key.musicBoxRepeat]: "ทำซ้ำ",
	[Key.musicBoxRepeatOne]: "ทำซ้ำเพลงเดียว",
	[Key.musicBoxProgress]: "ความคืบหน้า",
	[Key.musicBoxCover]: "ปก",
};
