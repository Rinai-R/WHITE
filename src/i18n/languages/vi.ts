...
export const vi: Translation = {
	...
	[Key.musicBoxPrev]: "Trước",
	[Key.musicBoxNext]: "Tiếp theo",
	[Key.musicBoxPlaylist]: "Danh sách phát",
	[Key.musicBoxMode]: "Chế độ phát",
	[Key.musicBoxVolume]: "Âm lượng",
	[Key.musicBoxMute]: "Tắt tiếng",
	[Key.musicBoxUnmute]: "Bật tiếng",
	[Key.musicBoxShuffle]: "Trộn",
	[Key.musicBoxRepeat]: "Lặp lại",
	[Key.musicBoxRepeatOne]: "Lặp lại một bài",
	[Key.musicBoxProgress]: "Tiến độ",
	[Key.musicBoxCover]: "Bìa",
};
